...
expose:
  type: ingress
  tls:
    enabled: false          # 学习环境不开 TLS
    certSource: none
  ingress:
    hosts:
      core: harbor.k8s.local
    className: nginx        # kubeadm 需要指定 ingressClassName
    annotations:
      nginx.ingress.kubernetes.io/proxy-body-size: "0"       # 不限上传大小
      nginx.ingress.kubernetes.io/proxy-read-timeout: "600"
      nginx.ingress.kubernetes.io/proxy-send-timeout: "600"

# ==========================================
# Harbor 对外访问地址(push/pull 用这个)
# ==========================================
externalURL: http://harbor.k8s.local:30080
